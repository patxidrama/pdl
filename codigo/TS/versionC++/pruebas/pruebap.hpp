...
#ifndef pruebaParser_INCLUDE
#define pruebaParser_INCLUDE
...
class pruebaParser : CRParser
{
  public:
    pruebaParser(AbsScanner *S=NULL, CRError *E=NULL) : CRParser(S,E) {};
    void Parse();
