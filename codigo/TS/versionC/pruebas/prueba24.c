// Prueba 24: "Existencia atributos - por posición"
// ---------------------------------

// Se comprobará que la función que
// determina la existencia de 
// atributos tambien funciona
// bien por poosicion.
...
int main()
{
	...
	printf("valor atributo 'tipo' en pos4"
	 " = %s\n",consultar_valor_atributo_cadena2(
	 pos4, "tipo"));;
	printf("valor atributo 'desplazamiento' en"
	 " pos1 = %d\n",
	...
	printf("existe 'desplazamiento' en pos1"
	 " = %d\n",existe_atributo2(pos1,
	 "desplazamiento"));
	printf("existe 'desplazamiento' en pos2"
	 " = %d\n",existe_atributo2(pos2,
	 "desplazamiento"));
	printf("existe 'desplazamiento' en pos3"
	 " = %d\n",existe_atributo2(pos3,
	 "desplazamiento"));
	printf("existe 'desplazamiento' en pos4"
	 " = %d\n",existe_atributo2(pos4,
	 "desplazamiento"));
