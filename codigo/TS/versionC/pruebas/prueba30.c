...
// Se observará que el programa se
// interrumpe de forma anómala si en
// vez de una posición se pone
// un número cualquiera que no
// se corresponda con una posición
...
int main()
{
	...
	// corresponda con una posición
	// tambien se interrumpirá. 
